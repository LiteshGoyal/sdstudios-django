                            ...
                            <div className="p-6 sm:py-8 sm:px-9">
                                ...
                                <form action="#" method="POST" className="mt-8 space-y-4">
                                    <div>
                                        ...
                                        <div>
                                            <input type="text" name="" id="" placeholder="First & Last name" className="block w-full px-5 py-4 text-lg border border-gray-400 text-white placeholder-gray-500 bg-[#05131c] rounded-md focus:border-white focus:ring-1 focus:ring-white" />
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <div>
                                            <input type="email" name="" id="" placeholder="Email address" className="block w-full px-5 py-4 text-lg border border-gray-400 text-white placeholder-gray-500 bg-[#05131c] rounded-md focus:border-white focus:ring-1 focus:ring-white" />
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <div>
                                            <input type="tel" name="" id="" placeholder="Phone number" className="block w-full px-5 py-4 text-lg border border-gray-400 text-white placeholder-gray-500 bg-[#05131c] rounded-md focus:border-white focus:ring-1 focus:ring-white" />
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <div>
                                            <textarea name="" id="" placeholder="Write your message" rows="4" className="block w-full px-5 py-4 text-lg border border-gray-400 text-white placeholder-gray-500 bg-[#05131c] rounded-md resize-y focus:border-white focus:ring-1 focus:ring-white"></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        <div className="relative inline-flex mt-2 group">
                                            ...
                                            <button type="button" className="relative inline-flex items-center justify-center px-8 py-3 text-base font-normal text-white bg-[#05131c] border border-transparent rounded-md" role="button">Send Message</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
